...
const CircularMenu: React.FC<CircularMenuProps> = ({ 
  isOpen, onToggle, onActivate, onScan, onConfigure, onDisengage, activeMode 
}) => {
    ...
    >
      ...
      <div className={`absolute transition-all duration-500 ease-out ${isOpen ? 'opacity-100 scale-100' : 'opacity-0 scale-50 pointer-events-none'}`}>
          ...
          <div className="relative w-64 h-64 -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2">
             ...
             <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-black rounded-full border border-neon-blue flex items-center justify-center shadow-[0_0_20px_rgba(0,243,255,0.3)] pointer-events-none">
